...
void move_forward(oi_t *sensor, int centimeters)
{
    ...
    while (sum < distance - 100)
    {
        ...
        else if(sensor->cliffFrontLeftSignal > 2700 || sensor->cliffFrontLeftSignal < 200 || sensor->cliffFrontRightSignal > 2700 || sensor->cliffFrontRightSignal < 200){
            cliff_detection(sensor);
        }
...
void cliff_detection(oi_t *sensor)
{
    oi_setWheels(0, 0);
    move_backward(sensor, 15);
    oi_setWheels(0, 0);
